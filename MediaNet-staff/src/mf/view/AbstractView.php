...
abstract class AbstractView {
    ...
    static protected $app_title    = "Medianet app Title"; /* un titre de document */
    ...
    public function render($selector){
        ...
        $styles = '';
        $this->addStyleSheet($app_root.'/css/adair.css');
        $this->addStyleSheet($app_root.'/css/clement.css');
        $this->addStyleSheet($app_root.'/css/jonathan.css');
        $this->addStyleSheet($app_root.'/css/mouad.css');
        $this->addStyleSheet($app_root.'/css/segolene.css');
